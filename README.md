...
El programa se rehizo tratando de aplicar capas de Logica, Controlador y Vista, con un paquete adicional para 
un par de clases que poseen algunas pruebas unitarias
